$(function() {
    ...
    function X(o) {
        L ? TweenLite.to($("body"), .5, {
            ...
            opacity: 0,
            onComplete: function() {
                $(".work-carousel .wc-nav").append('<span class="ajax-loader vertical-Center"><a href="/" class="icon-close anchor css3Animate"></a><span class="loader css3Animate"></span></span>'), $("#wrap").after("<div id='content' class='project-page'></div>"), $(".js .ajax-loader").css({
